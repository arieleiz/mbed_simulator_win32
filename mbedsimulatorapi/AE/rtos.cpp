...
{
	if (enable)
		AESIM::serial_attach(obj, irq);
	else
		AESIM::serial_detach(obj);
}

int  serial_getc(serial_t *obj)
{
	return AESIM::serial_getc(obj);
}

void serial_putc(serial_t *obj, int c)
{
	AESIM::serial_putc(obj, c);
}

int  serial_readable(serial_t *obj)
{
	return AESIM::serial_readable(obj);
}
