...
{
	AESIM::gpio_write(obj->pin, obj->is_out ? true : false, value);
}

int  gpio_read(gpio_t *obj)
{
	return AESIM::gpio_read(obj->pin, obj->is_out ? true : false);
}
...
void gpio_init_out_ex(gpio_t* gpio, PinName pin, int value)
{
	gpio->pin = pin;
	gpio->is_out = true;
	AESIM::gpio_write(pin, gpio->is_out ? true : false, value);
}
