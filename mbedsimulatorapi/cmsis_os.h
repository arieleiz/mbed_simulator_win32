...
#define DEFAULT_STACK_SIZE         524288 // AE
...
extern "C"
{
	...
	typedef struct Win32Thread Win32Thread;
...
typedef enum  {
	osPriorityIdle = THREAD_PRIORITY_IDLE,          ///< priority: idle (lowest)
	osPriorityLow = THREAD_PRIORITY_LOWEST,          ///< priority: low
	osPriorityBelowNormal = THREAD_PRIORITY_BELOW_NORMAL,          ///< priority: below normal
  osPriorityNormal        =  0,          ///< priority: normal (default)
  osPriorityAboveNormal = THREAD_PRIORITY_ABOVE_NORMAL,          ///< priority: above normal
  osPriorityHigh = THREAD_PRIORITY_HIGHEST,          ///< priority: high
  osPriorityRealtime = THREAD_PRIORITY_TIME_CRITICAL,          ///< priority: realtime (highest)
  osPriorityError         =  0x84        ///< system cannot determine priority or thread has illegal priority
} osPriority;

/// Timeout value.
/// \note MUST REMAIN UNCHANGED: \b osWaitForever shall be consistent in every CMSIS-RTOS.
#define osWaitForever     INFINITE     ///< wait forever timeout value
...
typedef struct os_thread_cb* osThreadId; // AE
